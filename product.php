    ...
    <div class="row mt-5 product">
        <div class="col-lg-4">
            ...
            <div class="product-btn button-group mt-3 row">
                <div class="col-lg-6">
                    <button class="btn btn-success btn-lg btn-block">Add To Cart &nbsp;<span><i
        ...
        <div class="col-lg-8">
            <div class="mt-2">
                <h2 class="title text-left">
                    Assassin's Creed: Valhalla | Standard Edition (PS5)
                </h2>
            </div>
            ...
            <div class="d-flex order-features mt-5 text-left">
                <div>
            ...
            <div class="mt-3">
                <p style="font-size: 0.8rem;">SELECTED OFFER FROM: Claincir | <span style="font-weight:600;">EXCELLENT
                        SELLER
